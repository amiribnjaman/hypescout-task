...
const SearchSection = ({ personDetails, setSearch, rangeValue, setRangeValue }) => {
            ...
            <div className=' w-10/12 dark:bg-[#17181B] bg-[#F7F7F8] mx-auto md:flex items-center justify-around py-4 px-4 md:px-0 '>
                ...
                <div className='mx-auto md:mx-0 relative'>
                    <button
                        ...
                        style={{ margin: '0 auto' }} type="button" class=" text-white bg-[#564FB1] flex items-center justify-around focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-3 mr-3 md:mr-2 hover:bg-[#564FB1] focus:outline-none 
                    ...
                    {/*------------- Filter box ---------------------*/}
                    <div className={`${showFilter ? 'block shadow-sm md:shadow-none' : ' hidden'} dark:bg-[#17181B] bg-[#F7F7F8] px-4 py-2 absolute shadow-md md:border md:border-slate-800 top-[75px] left-[-27px] md:top-[70px] md:left-[-130px] rounded-md z-10 w-80`}>
                        ...
                        <div className='mb-2'>
                            <label for="countries" class="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-400">Influencer’s Social Media Platform</label>
                            <p className='text-black dark:text-white'>{rangeValue}</p>
                            <input
                                onChange={(e) => setRangeValue(e.target.value)}
                                id="small-range" type="range" value={rangeValue} class="w-full h-1 text-[#564FB1] bg-[#564FB1] rounded-lg appearance-[#564FB1] cursor-pointer" />
                        ...
                        <div className='mb-2'>
                            ...
                            <div className='flex'>
                                <div class="flex items-center mr-4">
                                    <input id="inline-radio" type="radio" value="" name="inline-radio-group" class="w-4 h-4 text-[#564FB1] border-[#564FB1] focus:ring-[#564FB1] dark:ring-offset-gray-800 focus:ring-1 dark:border-[#564FB1]" />
                        ...
                        <div className='text-right'>
                            <button type="button" class="text-white bg-black focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 mr-2 mb-2  dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800">Reset</button>
                            <button
                                type="button" class="py-2.5 px-5 mr-2 mb-2 text-sm font-semibold text-white focus:outline-none bg-[#564FB1] rounded-lg border border-gray-200 hover:bg-gray-100 hover:text-blue-700 focus:z-10 focus:ring-4 focus:ring-gray-200 dark:focus:ring-gray-700 dark:border-gray-600 dark:hover:text-white dark:hover:bg-gray-700">Apply</button>
                        </div>
