          ...
          <div class="flex items-center">
            <ul class="mt-0 space-x-4 text-sm font-medium flex justify-between items-center">
              <li className="mr-1 md:mr-2">
                <a
                  href="javascript:void(0)"
                  class="text-gray-90  dark:text-gray-100 hover:underline"
                  aria-current="page"
                >
                  <svg
              ...
              <li className="mr-1 md:mr-2">
                <button
                  ...
                  class="mt-1 relative text-gray-900  dark:text-gray-100 hover:underline"
                >
                  {isDark ? (
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
              ...
              <li className="mr-1">
                <a
                  href="javascript:void(0)"
                  class="text-gray-900 w-12 h-12 md:w-16 md:h-16 dark:text-white hover:underline"
                >
                  <img src={Person} alt="" />
                </a>
              </li>
