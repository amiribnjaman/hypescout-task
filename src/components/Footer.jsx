      ...
      <div className="w-full pt-10 dark:bg-[#17181B] bg-[#F7F7F8] dark:border dark:border-black">
        <footer class="py-4 w-10/12 mx-auto sm:py-6">
          ...
          <div>
            <div class="md:flex gap-5 md:justify-between">
              <div className="md:w-3/12">
                <p class="mb-6 text-[13px] text-gray-900 dark:text-gray-400 text-center md:text-left">
              ...
              <div className="grid grid-cols-2 md:grid-cols-3 md:w-8/12">
                  ...
                  <ul class="text-gray-600 dark:text-gray-400">
                    <li class="mb-2">
                      <a
                        ...
                        class="hover:underline text-xs md:text-base"
                      >
                        About Us
                      </a>
                    </li>
                ...
                <div className="-mt-28 md:mt-0">
                  <h2 class="md:mb-4 mb-1 text-sm font-semibold text-gray-900 dark:text-white md:mt-0 mt-4">
                    Advertiser
                  </h2>
                  <ul class="text-gray-600 dark:text-gray-400">
                    <li class="mb-2">
          ...
          <div class="md:mt-20 mt-10 flex md:flex-row text-center flex-col-reverse sm:items-center sm:justify-between">
            <span class="text-sm my-6 text-gray-500 sm:text-center dark:text-gray-400">
              &copy;{" "}
