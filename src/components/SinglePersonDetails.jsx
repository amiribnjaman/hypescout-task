    ...
    return (
        <div className='dark:bg-[#17181B] bg-[#F7F7F8] w-full flex items-center justify-center text-center h-[475px] rounded'>
            <div className='text-center'>
                ...
                <h3 className='text-xl font-semibold dark:text-white text-black'>{name}</h3>
                <h5 className='text-md text-[#637381] flex items-center justify-center my-2'>
                    ...
                    {location}</h5>
                <h6 className='text-[#637381] flex items-center justify-center'>
                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="mr-2 bi bi-clock" viewBox="0 0 16 16">
                ...
                <div className='mt-6 flex justify-center'>
                    <ul class="text-gray-600 dark:text-gray-400 flex items-center">
                        <li className='mx-3 text-[#564FB1] dark:text-[#637381]'>
                ...
                <div className='mt-6'>
                    <ul className='flex gap-4'>
                        ...
                        <li className='flex flex-col border border-[#637381] border-dashed px-2 py-1'>
                            <span className='text-[#564FB1] dark:text-[#95B3CD] text-sm font-semibold'>{categories}</span>
                            <span className='dark:text-[#637381] text-sm'>Categories</span>
                        </li>
                        <li className='flex flex-col border border-[#637381] border-dashed px-2 py-1'>
                            <span className='text-[#564FB1] dark:text-[#95B3CD] text-sm font-semibold'>{gender}</span>
